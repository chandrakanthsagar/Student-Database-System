    ...
    try
        ...
        if(e.getSource()==b3){
          Class.forName("oracle.jdbc.driver.OracleDriver");
				...
				String sql = "insert into markssheet values(\'"+t1.getText()+"\',\'"+t2.getText()+"\',"+t7.getText()+","+t8.getText()+","+t9.getText()+","+t10.getText()+","+t11.getText()+","+t12.getText()+","+t3.getText()+",\'"+t4.getText()+"\',\'"+t13.getText()+"\'";
